...
const BecomeInstructor = () => {
  return (
    <div className="min-h-screen flex lg:flex-row flex-col lg:p-12 p-4 lg:items-center gap-8 justify-between">
      <div className="flex flex-col gap-8 w-[50%] ">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
          <div className="flex items-center gap-4 p-2">
            <div className="font-semibold text-[#564FFD] text-2xl p-4 rounded-full bg-[#EBEBFF]">
              1
            </div>
          ...
          <div className="flex items-center gap-4">
            <div className="font-semibold text-[#FF6636] text-2xl p-4 rounded-full bg-[#FFF0F0]">
              2
            </div>
          ...
          <div className="flex items-center gap-4">
            <div className="font-semibold text-[#E34444] text-2xl p-4 rounded-full bg-[#FFF0F0]">
              3
            </div>
          ...
          <div className="flex items-center gap-4">
            <div className="font-semibold text-[#23BD33] text-2xl p-4 rounded-full bg-[#E1F7E3]">
              4
            </div>
      ...
      <div className="flex flex-row bg-[#5F36A8] p-6 justify-between items-center w-[50%]">
