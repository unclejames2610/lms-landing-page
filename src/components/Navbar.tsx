    ...
    <div className="flex flex-col relative">
      <div className="flex justify-between items-center p-4 lg:pt-10 bg-white">
        ...
        <div className="flex lg:gap-12 md:gap-8 gap-2 items-center">
          ...
          <Link
            to="/signup"
            className="text-white px-6 py-2 rounded-lg bg-mainPurple font-mulish font-[800] text-[15px] leading-[22.5px] border-2 border-mainPurple hidden lg:block lg:w-32 cursor-pointer text-center"
          >
            Sign Up
          </Link>
      ...
      {navOpen && (
        <div className="bg-white gap-8 flex flex-col p-4">
          ...
          <Link
            to="/signup"
            className="text-white px-4 py-2 rounded-lg bg-mainPurple font-mulish font-[800] text-[15px] leading-[22.5px] border-2 border-mainPurple cursor-pointer text-center"
          >
            Sign Up
          </Link>
        </div>
